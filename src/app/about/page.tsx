...
//       <section className="bg-zinc-900 text-gray-800 py-24">
//         <div className="container mx-auto px-6 md:px-20 flex flex-col md:flex-row items-center gap-10">
//           {/* Text Section */}
//           <div className="md:w-1/2">
//             <p className="text-sm tracking-widest text-yellow-600/40 uppercase mb-3">
//              — About Us
//             </p>
...
//               purus, sit amet bibendum nisl. Cras mollis turpis a ipsum
//               ultrices, nec condimentum ipsum consequat. Mauris vitae consequat
//               nibh, vitae interdum mi.
//             </p>
//             {/* <div className="mb-6 space-x-6 text-xs uppercase tracking-wide text-gray-500">
//               <span>Architecture</span> /<span> Interior Design</span> /
//               <span> Furniture</span>
//             </div> */}
